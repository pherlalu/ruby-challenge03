...
product2 = Product.new(name: 'Product 2', price: 20, stock_quantity: 200, category: category)
product2.save

# Method Three: Create the object and persist it all at once.
product3 = Product.create(name: 'Product 3', price: 30, stock_quantity: 300, category: category)
